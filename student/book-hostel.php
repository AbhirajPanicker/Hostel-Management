...
<!-- By CodeAstro - codeastro.com -->
    ...
    <div class="text-center">
        <button type="button" id="payNowBtn" class="btn btn-success" data-toggle="modal" data-target="#paymentModal">Pay Now</button>
        <button type="submit" id="submitBtn" name="submit" class="btn btn-primary" style="display: none;">Submit Booking</button>
    ...
    <button type="button" class="btn btn-success" onclick="validatePayment()">Confirm Payment</button>
</div>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    ...
    window.validatePayment = function() {
        ...
        alert('Payment details validated! Please click Submit Booking to complete your registration.');
    }
});
</script>
    <script>
